...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    #* get the camera views for training
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        #* codes related to the interactive GUI, ignore for now
        ...
        iter_start.record()
        #* actual training begin here, update the training parameters
        ...
        # getting the current camera view
        ...
        gt_image, alpha_mask = viewpoint_cam.get_latent_feature()
